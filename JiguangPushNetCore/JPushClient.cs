...
namespace Jiguang.JPush
{
    public class JPushClient
    {
        ...
        public JPushClient(IOptions<JPushConfiguration> options)
        {
            var Config = options.Value;
            InitJPushClient(Config.AppKey, Config.MasterSecret);
        }

        public void InitJPushClient(string appKey, string masterSecret)
        {
